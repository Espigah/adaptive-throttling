...
function createAdaptiveThrottlingHistory(historyTimeMinute, k, upperLimiteToReject) {
  ...
  var filterOldestHistory = function filterOldestHistory(value) {
    var date = checkDate(historyTimeMinute);
    return value > date;
  };

  return {
    addRequests: function addRequests() {
      requestsHistory.push(Date.now());
      return this;
    },
    addAccepts: function addAccepts() {
...
exports.AdaptiveThrottling = AdaptiveThrottling;
exports.createAdaptiveThrottling = createAdaptiveThrottling;
//# sourceMappingURL=adaptive-throttling.cjs.development.js.map
